...
from data_parser import parse_employees_from_file, parse_managers_from_file, parse_properties_from_file
...
class StartupUI:
	def __init__(self):
		try:
			...
			self.property_data = parse_properties_from_file('fasteignir.json')
